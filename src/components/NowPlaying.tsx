      ...
      <div className="flex flex-col gap-4">
        <div>
          ...
          <div className="text-[13px] leading-relaxed mt-2" style={{ color: "rgba(237,224,206,.48)", maxWidth: 290 }}>
            {note ? "Spotify connect isn't wired up in this build yet — the ambience mixer keeps the room going." : "Ambience keeps playing without it. Connect Spotify Premium when you want records on the desk too."}
          </div>
        </div>
        <button
